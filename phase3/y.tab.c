...
static const char *const yytname[] =
{
  ...
  "ADD", "SUB", "MULT", "DIV", "MOD", "L_SQAURE_BRACKET",
  "R_SQUARE_BRACKET", "L_PAREN", "R_PAREN", "$accept", "ident",
  "prog_start", "functions", "function", "comma", "identifiers",
  "declarations", "declaration", "states", "statements", "statement",
  "or_expr", "and_expr", "bool_expr", "relation_and_expr", "relation_expr",
  "comp", "expressions", "expr", "expression", "mult_expr",
...
{
      28,   -66,   -28,    10,   -66,    14,   -66,    -6,   -66,   -66,
       9,   -28,     4,    15,    42,    21,   -28,   -66,    55,    52,
     -28,   -66,   -66,    11,    31,   -28,   -66,    40,   -28,    80,
      39,    43,    89,    81,   -66,    91,    90,    51,    51,    82,
     -28,   -28,     3,   -66,    57,   100,    87,    78,   -66,   -66,
     -66,   -66,    53,    24,    51,    -9,   115,    96,    97,   101,
     -24,    45,   -66,    95,    91,   103,   103,     3,   -66,     3,
     -66,    91,     3,   -66,   -66,    51,   101,   -66,     3,   -66,
      84,    86,     3,    91,    51,   -66,    51,   -66,   -66,   -66,
     -66,   -66,   -66,   -66,     3,     3,     3,   -66,     3,     3,
       3,   -66,    91,   112,   -28,   -66,   -66,    85,    98,   -66,
     -66,   -66,    93,     3,    94,   -66,   -66,    99,   118,    46,
      96,    97,   -66,   -24,   -66,   -66,   -66,   -66,   127,   131,
     103,   -66,   -66,   -66,   -66,   -66,     3,   -66,    91,   -66,
     -66,   -66,   -66,    51,   -66,   -66,   136,   -66,   -66
};
...
{
     -66,    -2,   -66,   149,   -66,   -66,   -12,   -18,   -66,   -66,
     -56,   -66,    35,    36,   -35,    72,    73,    88,    25,    37,
     -22,   -66,   -25,    22,   -65,   -29
};
...
{
       7,   106,    26,    63,    21,     6,    47,    29,   103,    12,
       8,    65,    66,    11,    12,   110,    31,     2,    12,    80,
      68,    95,    96,    12,    79,    10,    12,   119,    -5,     1,
      76,     2,    81,    44,    16,    47,     6,    51,    44,    44,
     112,    69,    47,    82,    18,   107,   128,   108,    19,    53,
     111,    44,    20,    81,    47,    67,   114,     6,    77,    25,
     118,    27,    44,   137,   138,   144,    22,    23,    24,    44,
     123,   124,   122,    47,    30,   130,    78,    49,    50,    73,
      74,    44,   146,    28,     6,    51,     6,    51,    32,    52,
      33,   133,    98,    99,   100,    36,    34,    53,    35,    53,
      44,    48,    44,    54,    64,    75,    37,    69,   147,    47,
      70,    38,    39,    72,   118,    40,    41,   102,    71,    42,
     125,   126,   127,    43,     6,    88,    89,    90,    91,    92,
      93,    83,    84,   104,    86,   129,    44,   115,   116,   116,
      88,    89,    90,    91,    92,    93,   132,   134,   136,   131,
     142,   143,   135,   148,     9,   139,   120,   140,     0,   121,
     141,   145,     0,     0,   113
};

static const yytype_int16 yycheck[] =
{
       2,    66,    20,    38,    16,    33,    35,    25,    64,    11,
       0,    40,    41,     4,    16,    71,    28,     3,    20,    54,
      42,    45,    46,    25,    53,    31,    28,    83,     0,     1,
      52,     3,    54,    35,    30,    64,    33,    34,    40,    41,
      75,    50,    71,    52,    29,    67,   102,    69,     6,    46,
      72,    53,    31,    75,    83,    52,    78,    33,    34,     7,
      82,    50,    64,    17,    18,   130,    11,    12,    13,    71,
      95,    96,    94,   102,    34,   104,    52,    26,    27,    26,
      27,    83,   138,    52,    33,    34,    33,    34,     8,    38,
      51,   113,    47,    48,    49,    14,    53,    46,     9,    46,
     102,    11,   104,    52,    22,    52,    15,    50,   143,   138,
      10,    20,    21,    35,   136,    24,    25,    22,    31,    28,
      98,    99,   100,    32,    33,    39,    40,    41,    42,    43,
      44,    16,    36,    30,    37,    23,   138,    53,    53,    53,
      39,    40,    41,    42,    43,    44,    53,    53,    30,    51,
      23,    20,    53,    17,     5,   120,    84,   121,    -1,    86,
     123,   136,    -1,    -1,    76
};
...
static const yytype_uint8 yystos[] =
{
      ...
      31,    60,    11,    12,    13,     7,    61,    50,    52,    61,
      34,    60,     8,    51,    53,     9,    14,    15,    20,    21,
      24,    25,    28,    32,    55,    64,    65,    79,    11,    26,
      27,    34,    38,    46,    52,    55,    68,    69,    70,    74,
      76,    77,    79,    68,    22,    79,    79,    52,    74,    50,
      10,    31,    35,    26,    27,    52,    74,    34,    52,    79,
      68,    74,    52,    16,    36,    66,    37,    67,    39,    40,
      41,    42,    43,    44,    71,    45,    46,    73,    47,    48,
      49,    75,    22,    64,    30,    78,    78,    74,    74,    63,
      64,    74,    68,    71,    74,    53,    53,    72,    74,    64,
      69,    70,    74,    76,    76,    77,    77,    77,    64,    23,
      79,    51,    53,    74,    53,    53,    30,    17,    18,    66,
